...
export const ctaConfigs = {
  ...
  home: {
    title: 'Снять квартиру в Мирном посуточно уже сегодня',
    description:
      'Свяжитесь с нами любым удобным способом. Квартиры на сутки без посредников. Работаем ежедневно с 8:00 до 22:00.',
    buttons: [
      {
        text: 'Снять квартиру',
        to: '/apartments',
  ...
  apartments: {
    itle: 'Не нашли подходящую квартиру на сутки?',
    description: 'Свяжитесь с нами, и мы поможем снять квартиру в Мирном посуточно специально для ваших потребностей.',
